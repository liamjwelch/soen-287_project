...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($username) || empty($first_name) || empty($last_name) || empty($phone_number) || empty($email_address)
        //  || empty($major)
    )
    {
        ...
        if (add_student($username, $first_name, $last_name, $phone_number, $email_address)) {
    ...
    <div align="center">
        ...
        <form class="form-container form-add" method="post" action="studentProfile.php">
            ...
            <fieldset style="width:30%">
                ...
                <div align="left">
                    <label for="name" value="<?php echo htmlspecialchars($username); ?>">
                    </label>
                    //hidden to prevent user from altering their own username input
                    <input name="username" id="username" type="hidden" value="<?php echo htmlspecialchars($username); ?>">
                    <br>
